...
Simulation = R6Class(
  ...
  public = list(
    ...
    #' @param max_human_infectivity maximum infectious period of a human in days
    ...
    initialize = function(humans,
      ...
      # Parameters
      self$humans = humans
      self$locations = tibble(locations, gametocyte_load = 0, EIR = 0)
    ...
    iterate = function(dt, debug=FALSE) {
      ...
      self$humans$blood_gametocyte_prob = private$human_infectivity(self$t - self$humans$t_infection)
      
      # Calculate gametocyte load per location
      ...
      new_mosquito_infections = self$locations %>%
        ...
        # Number of new infected mosquitoes generated by this human
