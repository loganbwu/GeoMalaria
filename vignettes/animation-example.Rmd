...
Only do this when rendering the RMarkdown locally.

```{r sampleani, fig.show='animate', aniopts="controls,loop", eval=FALSE}
plot_anim(sim, file="animation.mp4")
```
