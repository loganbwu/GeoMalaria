...
Verify that iff relapse is disabled <=> MDA will stop transmission
...
```{r}
# No infections occur after MDA
testthat::expect_equal(max(sim_norelapse$history_infections$t_infection) <= 100, TRUE)
# Relapse brings transmission back after MDA
testthat::expect_equal(max(sim_relapse$history_infections$t_infection) > 100, TRUE)
